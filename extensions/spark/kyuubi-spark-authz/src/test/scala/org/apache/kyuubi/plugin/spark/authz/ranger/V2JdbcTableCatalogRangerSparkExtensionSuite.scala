  ...
  test("[KYUUBI #3424] CREATE TABLE") {
    withSingleCallEnabled {
      ...
      assert(e2.getMessage.contains(s"does not have [create] privilege" +
        s" on [iceberg/$namespace1/$table2]"))
  ...
  test("[KYUUBI #3424] INSERT TABLE") {
    ...
    withSingleCallEnabled {
      ...
      assert(e4.getMessage.contains(s"does not have [update] privilege" +
        s" on [iceberg/$namespace1/$outputTable1]"))
    ...
    withSingleCallEnabled {
      ...
      withSingleCallEnabled {
        ...
        assert(e2.getMessage.contains(s"does not have" +
          s" [select] privilege" +
          s" on [iceberg/$namespace1/$table1/city,iceberg/$namespace1/table1/id,iceberg/$namespace1/$table1/name]," +
          s" [update] privilege on [iceberg/$namespace1/$outputTable1]"))
      }
    }
  }

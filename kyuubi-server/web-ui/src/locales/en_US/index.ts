...
export default {
  ...
  spark_connect: {
    ...
    diagnostics_note:
      'Where a session that will not start says why. The driver runs as its own pod, so its log and its Kubernetes events are separate from what Kyuubi printed while submitting it.',
    tab_driver: 'Driver',
    tab_driver_log: 'Driver log',
    tab_submit_log: 'Submit log',
    tab_events: 'Events',
    no_driver_yet:
      'This session has no driver pod. Nothing below describes a running driver.',
    driver_pod: 'Pod',
    ...
    driver_containers: 'Containers',
    container_name: 'Container',
    container_state: 'State',
    container_ready: 'Ready',
    container_restarts: 'Restarts',
    container_last_termination: 'Last termination',
    ...
    event_count: 'Count',
    event_last_seen: 'Last seen',
    empty_log: 'Nothing logged yet.',
    load_diagnostics_failed: 'Failed to load diagnostics: {message}'
  },
  message: {

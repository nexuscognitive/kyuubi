...
export default {
  ...
  spark_connect: {
    ...
    state_dead_note:
      '此会话的 Spark driver 已经死亡。在新的 driver 替换它之前，会话不可用。',
    state_recovering_note:
      'Driver 已死亡，正在启动替代者。Spark 客户端会持续重试直到其可用。',
    state_failed_note:
      '此会话已结束。Kyuubi 不会再为它启动 driver，请创建新会话。',
    recovery: 'Driver 恢复',
    recovery_note:
      '被替换的 driver 是一个全新的 Spark 会话。恢复只能重建可连接的端点，无法恢复旧 driver 中的内容。',
    restart_count: '已替换的 driver 数',
    generation: '引擎代次',
    last_restart: '最近一次替换',
    never_restarted: '从未替换 —— 此会话仍在最初的 driver 上。',
    recovery_abandoned: '已放弃恢复',
    state_loss_warning: '你的 Spark 会话已被替换',
    post_mortems: 'Driver 的死亡原因',
    post_mortems_note:
      '在每个 driver 死亡时抓取。Kubernetes 会随 Pod 一起删除其事件，因此 Pod 消失后只剩这些记录。',
    no_post_mortems: '此会话没有记录到任何 driver 死亡。',
    post_mortem_when: '死亡时间',
    post_mortem_driver: 'Driver',
    post_mortem_cause: '原因',
    post_mortem_state: '最终状态',
    post_mortem_oom: '内存耗尽',
    post_mortem_events: '死亡时的事件',
    post_mortem_containers: '容器',
    container_exit_code: '退出码',
    container_signal: '信号',
    container_finished_at: '结束时间',
    event_type: '类型',
    event_reason: '原因',
    event_message: '消息',
    event_count: '次数',
